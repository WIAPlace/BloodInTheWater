...
public class SeePlaceableAreas : MonoBehaviour
{
    ...
    {// on holding down place button allow them to see
        ...
        currentHolding = PlayerHolding.Instance.CheckInHand();
        ...
        PlayerHolding.Instance.SetChecking(true); // communication for placeable spots
    }
    ...
    {// on letting go of place button turn off ability to see.
        ...
        PlayerHolding.Instance.SetChecking(false); // communication for placeable spots
    }
}
